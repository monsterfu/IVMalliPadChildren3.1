...
//        rect.size.height - 400
        ...
        pointsLab = [[UILabel alloc] initWithFrame:CGRectMake((552)/2-40-220, 130, rect.size.height - 400, 30)];
        ...
        UILabel * lab = [[UILabel alloc] initWithFrame:CGRectMake(25, alipayView.frame.size.height - 50, 50, 30)];
        lab.backgroundColor = [UIColor clearColor];
        lab.text = @"总价:";
        lab.alpha = alpha_4;
        lab.font = font_5;
        ...
        pointLab = [[UILabel alloc] initWithFrame:CGRectMake(80, alipayView.frame.size.height - 55, 180, 40)];
        ...
        aliPayBtn1.frame = CGRectMake(alipayView.frame.size.width - 30 - 130, alipayView.frame.size.height - 55, 130, 51);
//        [aliPayBtn1 redStyle];
...
-(NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return pointsModel.list.count/3;
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    lastCLickBtn.layer.borderColor = [UIColor lightGrayColor].CGColor;
    for (int i = 0; i < 3; i++) {
        if (pointsModel.list.count > indexPath.row * 3 + i) {
...
//                [lastCLickBtn setBackgroundImage:[UIImage imageNamed:@"Selected"] forState:UIControlStateNormal];
                pointLab.text = [NSString stringWithFormat:@"%0.2f元",pointModel.price];
            }
    ...
    else
    {
        [UIView animateWithDuration:1.0
                         animations:^{
                             ...
                             UIView * view1 = [_ViewCtl.view.subviews lastObject];
                             UIView * view2 = [_ViewCtl.view.subviews objectAtIndex:_ViewCtl.view.subviews.count - 2];
                             view1.hidden = NO;
                             view2.hidden = NO;
...
//                [[AppDelegate App].userView.myTableView reloadData];
                ...
                [Commonality showErrorMsg:self type:0/*lm.result*/ msg:nil];
            }
        }
    }
