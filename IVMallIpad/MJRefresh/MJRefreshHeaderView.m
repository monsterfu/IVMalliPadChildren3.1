...
- (void)setState:(RefreshState)state
{
	...
	switch (_state = state) {
		case RefreshStatePulling:
        {
            ...
            if (_headerDelegate &&  [_headerDelegate respondsToSelector:@selector(refreshViewShouldBeginRefreshing)]) {
                [_headerDelegate refreshViewShouldBeginRefreshing];
            }
