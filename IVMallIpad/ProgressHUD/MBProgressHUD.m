...
- (void)layoutSubviews {
    ...
    if (nil != self.labelText) {
        ...
        CGSize dims = [self.labelText sizeWithAttributes:[NSDictionary dictionaryWithObject:self.labelFont forKey:NSFontAttributeName]];//[self.labelText sizeWithFont:self.labelFont];
        ...
        if (nil != self.detailsLabelText) {
			...
			CGSize labelSize =[detailsLabel.text boundingRectWithSize:CGSizeMake(frame.size.width - 4*margin, maxHeight) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:[NSDictionary dictionaryWithObject:detailsLabel.font forKey:NSFontAttributeName] context:nil].size;
